		...
		<div class="row">
			<div class="col-md-10 offset-md-1 pt-3">
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-3 db-item-wrap">
						...
						<div class="db-item-bottom">
							<p>
							@if($node->access_type == 1)
							<strong style="font-style: normal; margin-right: 3px">Publik</strong>
							@else
							<strong style="font-style: normal; margin-right: 3px">Private</strong>
							@endif

							@if(count($node->sensors) > 0)
							<span>{{ implode(', ', array_column(json_decode($node->sensors), 'name')) }}</span>
							@else
							<span>-</span>
							@endif
							</p>
